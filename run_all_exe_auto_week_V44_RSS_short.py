...
def exe_japanese_stocks():
    ...
    conda_env = "py310_fx"
    scripts_list = [
        ("C:/workspace/nihon_kabu_trade/RSS_NEW_SHORT", "nihon_ver1.12_open_v6_load_sim_ansemble5_bigcompany_top40_1day_paralel_v2_ESS_short_v2_normal_1week.py"), 
        ("C:/workspace/nihon_kabu_trade/ess", "nihon_ver1.12_open_v6_load_sim_ansemble5_bigcompany_top40_1day_paralel_v2_ESS.py"),        
