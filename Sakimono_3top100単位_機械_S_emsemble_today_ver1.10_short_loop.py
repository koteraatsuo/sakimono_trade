...
for num in [0.005, 0.006, 0.007, 0.008, 0.009, 0.010, 0.011,0.012,0.013,0.014,0.015,]:
    ...
    ranks = []
    for investment in record_investments:
        # 自分より大きい値の個数に1を足す
        rank = 1 + sum(1 for x in record_investments if x > investment)
        ranks.append(rank)
