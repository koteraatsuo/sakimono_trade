...
def exe_japanese_before_scripts():
    ...
    conda_env = "py310_fx"
    scripts_list = [
        ("C:/workspace/nihon_kabu_trade", "nihon_ver1.12_open_v5_before_sim_ansemble_bigcompany_top70.py"),
...
def exe_before_cfd_scripts():
    ...
    scripts_list = [
        ("C:/workspace/cfd_trade", "nihon_ver1.12_open_v5_before_sim_ansemble_bigcompany.py"),
...
def exe_cfd_scripts():
    ...
    scripts_list = [
        ...
        ("C:/workspace/cfd_trade", "nihon_ver1.12_open_v5_load_sim_ansemble_bigcompany.py"),
