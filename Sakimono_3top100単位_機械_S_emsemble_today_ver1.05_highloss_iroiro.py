...
futures_tickers = {
    "Indices": [
        "NK=F", "TPX=F", "YM=F", "ES=F", "NQ=F", "RTY=F", "A50=F", "HSI=F",
        "FTSE=F", "EURO50=F", "DAX=F", "CAC=F"
    ],
    "Commodities": [
        "GC=F", "SI=F", "HG=F", "BZ=F", "CL=F", "NG=F", "HO=F", "RB=F",
        "ZC=F", "ZS=F", "ZW=F", "CT=F", "KC=F", "CC=F", "SB=F"
    ],
    "Energy": [
