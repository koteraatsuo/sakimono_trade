...
def exe_japanese_stocks():
    ...
    conda_env = "py310_fx"
    scripts_list = [
        ("C:/workspace/nihon_kabu_trade/RSS_NEW", "nihon_ver1.12_open_v6_load_sim_ansemble5_bigcompany_top40_1day_paralel_v2_ESS_v2_1week_1st.py"), 
        ("C:/workspace/nihon_kabu_trade/RSS_NEW", "nihon_ver1.12_open_v6_load_sim_ansemble5_bigcompany_top40_1day_paralel_v2_ESS_v2_1week_2nd.py"),        
        # ("C:/workspace/nihon_kabu_trade", "nihon_ver1.12_open_v5_load_sim_ansemble5_bigcompany_top40_1day_v3.py"),
...
def exe_sakimono_scripts():
    ...
    conda_env = "py310_fx"
    scripts_list = [
        ("C:/workspace/sakimono_trade", "Sakimono_ver1.15_open_commodity_load.py"),
...
def exe_japanese_before_scripts():
    ...
    scripts_list = [
        ...
        ("C:/workspace/nihon_kabu_trade/ess", "nihon_refresh_list_V2.py"),
        ("C:/workspace/nihon_kabu_trade/ESSSHORT", "nihon_refresh_list_down_V2.py"),
...
schedule.every().day.at("08:45").do(lambda: schedule_job("japanese"))
