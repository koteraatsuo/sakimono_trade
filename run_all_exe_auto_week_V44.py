...
def exe_japanese_stocks():
    ...
    conda_env = "py310_fx"
    scripts_list = [
        ("C:/workspace/nihon_kabu_trade", "nihon_ver1.12_open_v6_load_sim_ansemble5_bigcompany_top40_1day_paralel_v2.py"),        
...
schedule.every().day.at("07:00").do(lambda: schedule_job("fx"))
schedule.every().day.at("08:30").do(lambda: schedule_job("japanese"))
